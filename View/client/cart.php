                            ...
                            <div class="table-responsive">
                                <table class="table table-cart">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="index.php?product=<?php echo $order["pk_product_id"] ?>"><?php echo $order["c_name"] ?></a></td>
                                    ...
                                    <tfoot>
                                    <tr>
                                        <td colspan="6"><a href="<?php echo explode('?',PATH)[0] ?>?action=destroy" class="button pull-left">Xóa toàn bộ</a> <a href="index.php" class="button pull-right black">Tiếp tục mua hàng</a>
